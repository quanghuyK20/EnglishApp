...
public class Listening_practice_Activity extends AppCompatActivity {
    ListView listView;
    ImageView imgback;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AddArrayBTN();
        boCauHoiAdapter = new learn_set_Adapter(Listening_practice_Activity.this, R.layout.row_listening_set, boCauHoiArrayList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                database = Database.initDatabase(Listening_practice_Activity.this, DATABASE_NAME);
                String a = null;
                ...
                Intent quiz = new Intent(Listening_practice_Activity.this, Listening_Activity.class);
        ...
        imgback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent
                        = new Intent(Listening_practice_Activity.this,
                        MainActivity.class);
