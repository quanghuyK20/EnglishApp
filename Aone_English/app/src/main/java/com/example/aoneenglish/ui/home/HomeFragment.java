...
import com.example.aoneenglish.Listening.Listening_practice;
import com.example.aoneenglish.Listening.Listening_practice_Activity;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        cardViewListening.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getActivity(), Listening_practice_Activity.class);
